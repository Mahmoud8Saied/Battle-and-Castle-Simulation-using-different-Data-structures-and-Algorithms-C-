...
public:
	...
	void UpdateStatusBar(int TimeStep, string msg);	//prints info on status bar. Info includes timestep and other enemies info as illustrated in project doc
	void UpdateInterface(int TimeStep, string msg);
